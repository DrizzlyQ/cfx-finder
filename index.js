...
bot.on('message', msg => {
    if(msg.content.startsWith(">find")){
                ...
                .then((out) => {
                    ...
                    if(!out["Data"]["connectEndPoints"][0].startsWith("http")){
                        ...
                        if(out["icon"]){
                            ...
                            .setFooter("Coded by Drizzly#9999")
        ...
        .setAuthor(msg.author.tag, msg.author.avatarURL())
        .setColor("#c73e10")
        .addField("\<:info:820801226216177684> CFX Server Info", "`>find [cfx code]`")
        ...
        .then((out) => {
            if(out["Data"]["vars"]["tags"] && out["Data"]["hostname"]){
                ...
                const mensaje = new Discord.MessageEmbed()
                .setAuthor(msg.author.tag, msg.avatarURL())
                .setColor("#c73e10")
